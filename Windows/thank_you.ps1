#This is the Windows version of the script that will automate writing Thank you letters
...
$Message | Add-Content -Path "C:\Users\YourUsernameHere/Desktop\$Name Thank you Letter.txt"
